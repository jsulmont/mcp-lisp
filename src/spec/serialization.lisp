    ...
    (labels ((emit (form) (prin1 form out) (terpri out) (terpri out))
      ...
      (maphash (lambda (k v)
                 ...
                 (let ((form `(defrule ,(getf v :name))))
                   ...
                   (when (getf v :after) (setf form (append form `(:after ,(getf v :after)))))
                   (when (getf v :creates) (setf form (append form `(:creates ,(getf v :creates)))))
                   (when (getf v :deletes) (setf form (append form `(:deletes ,(getf v :deletes)))))
